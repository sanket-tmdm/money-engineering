...
# coding=utf-8
"""
Replay Consistency Test for IronOreIndicator
...
# Test configuration
INDICATOR_NAME = "IronOreIndicator"
SOURCE_FILE = "IronOreIndicator.py"
GRANULARITY = 900
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Test replay consistency for IronOreIndicator"
    )
    parser.add_argument(
        "--start",
