...
# coding=utf-8
"""
Replay Consistency Test for SoybeanIndicator
...
# Test configuration
INDICATOR_NAME = "SoybeanIndicator"
SOURCE_FILE = "SoybeanIndicator.py"
GRANULARITY = 900
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Test replay consistency for SoybeanIndicator"
    )
    parser.add_argument(
        "--start",
