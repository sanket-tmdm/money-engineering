...
# coding=utf-8
"""
CopperIndicator - Pure Signal Generator (Tier 1 Indicator)

PURE SIGNAL GENERATION with 7-Indicator Market Regime Detection:
- Triple EMA (12/24/45) - FASTER trend identification for reactive copper trading
- MACD (12/24/9) - Momentum confirmation & reversal detection
- RSI (12) - MORE SENSITIVE mean reversion signals
...
- FASTER parameters than Iron Ore (copper is more reactive)
